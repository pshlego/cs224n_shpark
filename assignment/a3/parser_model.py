...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden_weight = nn.Parameter(torch.zeros(embeddings.shape[1]*self.n_features, self.hidden_size))
    ...
    def forward(self, w):
        ...
        m = nn.ReLU()
        h = m(torch.matmul(X,self.embed_to_hidden_weight)+self.embed_to_hidden_bias)
